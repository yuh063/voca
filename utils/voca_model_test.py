...
class VOCAModel(BaseModel):
    ...
    def _training_step(self):
        processed_audio, blendshapes = self.batcher.get_training_batch(self.config['batch_size'])
    ...
    def _validation_step(self):
        processed_audio, blendshapes = self.batcher.get_validation_batch(self.config['batch_size'])
